...
export default class Edit extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Typography style={{fontWeight:'600', fontSize:'1.5rem', marginTop:'3vw', marginLeft:'4vh'}}>Revise</Typography>
                ...
                />
                Revise Relation
                    <div style = {{display: this.state.selectedRevise == "element" ? 'block':'none'}}>
                        {figure_element}
                        {table_element}
                    </div>
                    <div style = {{display: this.state.selectedRevise == "relation" ? 'block':'none'}}>
                        {figure_relation}
                        {table_relation}
                    </div>
                </div>
